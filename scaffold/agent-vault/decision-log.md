...
Use one note per durable decision in `decisions/` and keep this file as the canonical index.
...
## Index
- `DEC-001` | proposed | YYYY-MM-DD | Title | `agent-vault/decisions/DEC-001-title.md`
